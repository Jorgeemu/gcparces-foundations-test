module "cs-folders-iam-0-computeinstanceAdminv1" {
  ...
  bindings = {
    "roles/compute.instanceAdmin.v1" = [
      "group:gcp-developers@iamjorgetestorg.joonix.net",
    ]
  }
}
...
module "cs-projects-iam-2-loggingviewer" {
  ...
  projects = [
    module.cs-logging-pa548-aq297.project_id,
  ]
  bindings = {
    "roles/logging.viewer" = [
      "group:gcp-logging-viewers@iamjorgetestorg.joonix.net",
    ]
  }
}
...
module "cs-projects-iam-3-bigquerydataViewer" {
  ...
  bindings = {
    "roles/bigquery.dataViewer" = [
      "group:gcp-security-admins@iamjorgetestorg.joonix.net",
    ]
  }
}
